  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <nav class="duration-1000 bg-white opacity-0 hover:opacity-100 bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 border-gray-600">
          <div class=" flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <a href="https://github.com/matheus-nantes?tab=repositories" class="flex left-4 items-center font-extrabold text-transparent text-xl bg-clip-text bg-gradient-to-t from-indigo-600 to-teal-300 hover:bg-gradient-to-t hover:from-teal-300 hover:via-indigo-500 hover:to-teal-300 hover:animate-pulse delay-300">
                Conheça o meu git
              </a>
              <button
